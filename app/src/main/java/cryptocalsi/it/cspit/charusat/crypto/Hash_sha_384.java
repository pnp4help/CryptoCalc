...
public class Hash_sha_384 extends Fragment {
        ...
        hash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(input_et.getText().toString().equals("")){
                    ...
                    output_tv.setText("Hash : "+hash_sha_functions.convertToSHA384(input_et.getText().toString()));
                }
            }
        });
    }
